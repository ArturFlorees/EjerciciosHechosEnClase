...
const ScreenUser = () => {
  ...
  return (
    <View>
      ...
      style={{marginTop:15, width:300}} icon="account-plus" mode="contained"
       onPress={()=> Navegacion.navigate("nuevouser",{hola:"Hola mundoooo", funcionobtenerdatos: obtenerdatos})}>
      Nuevo Usuario
      </Button>
      <Card mode='contained'>
      <TablaUsuario2
